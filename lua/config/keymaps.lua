...
-- Windows
set("n", "<leader>wv", "<C-W>v", { noremap = true, desc = "Split Window Right" })
set("n", "<leader>ws", "<CMD>:split<CR>", { noremap = true, desc = "Split Window Below" })
set("n", "<leader>wd", "<C-W>c", { noremap = true, desc = "Close Window" })
set("n", "<leader>wo", "<C-W>o", { noremap = true, desc = "Close all other windows" })
...
end, { noremap = true, desc = "Toggle Maximize Window" })
